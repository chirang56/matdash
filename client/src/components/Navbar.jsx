...
const NAV_ITEMS = ['Home', 'Shop', 'About', 'Services', 'Contact'];
      ...
      <nav className="container mx-auto max-w-[1440px] px-4 md:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            />
            <button type="submit" className="px-4 py-2 text-blue-700 hover:bg-gray-200" aria-label="Search">
              <FaSearch />
            </button>
          </form>
          <div className="flex items-center space-x-5">
            ...
            <div className="relative" ref={profileDropdownRef}>
              ...
              {profileDropdownOpen && (
                <div className="absolute right-0 mt-3 w-48 bg-white shadow-lg rounded-lg py-2 z-50 border border-gray-200">
                  <Link to="/profile" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 hover:text-blue-600" onClick={() => setProfileDropdownOpen(false)}>
                    My Profile
                  </Link>
                  <Link to="/orders" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 hover:text-blue-600" onClick={() => setProfileDropdownOpen(false)}>
                    My Orders
                  </Link>
                  <Link to="/wishlist" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 hover:text-blue-600 sm:hidden" onClick={() => setProfileDropdownOpen(false)}>
                    My Wishlist
                  </Link>
            ...
            <Link to="/cart" className="relative" aria-label="Shopping cart with 2 items">
              ...
              <span className="absolute -top-2 -right-2 bg-blue-600 text-white text-xs font-bold px-2 py-0.5 rounded-full">2</span>
            </Link>
            <button
